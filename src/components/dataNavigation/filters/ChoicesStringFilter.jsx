...
/*
  ...
  filterTitle
  icon
  filteringFunction NOTE THAT THE FUNCTION CAN BE EMBEDDED, AS IT WILL ALWAYS BE OF THE SAME KIND
  MAYBE WE CAN JUST PASS IF WE WANT IT TO BE AN OR, OR AN AND BASED FILTER
